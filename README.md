...
- [Configuration](https://michael-freling.github.io/claude-forge/docs/configuration/) — the `config.yaml` reference
...
- [Authentication](https://michael-freling.github.io/claude-forge/docs/authentication/) — how credentials are resolved
