...
MCP server scoped to your repository comes built in, first-party Kubernetes
and Google Cloud servers ship in the repo, and you can add your own servers.
...
{{< cards >}}
  ...
  {{< card link="mcp-servers" title="MCP Servers" icon="puzzle" subtitle="The built-in GitHub server, the first-party Kubernetes and Google Cloud servers, and how to add your own." >}}
