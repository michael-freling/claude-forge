...
// TestRestartSharedMCP_NoSharedServers verifies restart is a no-op when no
// global MCP servers are configured.
func TestRestartSharedMCP_NoSharedServers(t *testing.T) {
	ctrl := gomock.NewController(t)
